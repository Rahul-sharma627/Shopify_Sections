...
{{- end -}}
{{< /buttons.inline >}}
<button type="button" class="btn btn-sm-primary">SmallHD</button>
<button type="button" class="btn btn-td-primary">Teradek</button>
<button type="button" class="btn btn-wc-primary">Wooden Cemra</button>
<button type="button" class="btn btn-purple">Purple Button</button>
<button type="button" class="btn btn-black">Black Button</button>
<button type="button" class="btn btn-white">White Button</button>
<button type="button" class="btn btn-gray">Gray Button</button>
...
{{- end -}}
{{< /buttons.inline >}}
<button type="button" class="btn btn-outline-sm-primary">SmallHD</button>
<button type="button" class="btn btn-outline-td-primary">Teradek</button>
<button type="button" class="btn btn-outline-wc-primary">Wooden Cemra</button>
<button type="button" class="btn btn-outline-purple">Purple Button</button>
<button type="button" class="btn btn-outline-black">Black Button</button>
<button type="button" class="btn btn-outline-white">White Button</button>
<button type="button" class="btn btn-outline-gray">Gray Button</button>
{{< /example >}}
